			...
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						<img class="img-radius" src="{{Asset('Asset/backend/images/user/avatar-2.jpg')}}" alt="User-Profile-Image">
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="form_elements.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">User</span></a>
					</li>
					<li class="nav-item">
